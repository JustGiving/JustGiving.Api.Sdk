...
namespace JustGiving.Api.Sdk.Test.Integration.ApiClients
{
    ...
    public class PageApiTests
    {
        ...
        {
            var client = new JustGivingClient(new ClientConfiguration("http://api.local.justgiving.com/", "000", 1) { Username = "apitests@justgiving.com", incorrectPassword = "password" });
        ...
        {
            var client = new JustGivingClient(new ClientConfiguration("http://api.local.justgiving.com/", "000", 1) { Username = "apitests@justgiving.com", incorrectPassword = "badincorrectPassword" });
            var pageClient = new PageApi(client);
