namespace JustGiving.Api.Sdk.Test.Integration
{
    ...
    {
        public static string ApiLocation = "https://api.justgiving.com/";
        ...
        public static string CharityTestUserName = "testuser@justgiving.com";
        public static string CharityTestUserPassword = "Testing123";
