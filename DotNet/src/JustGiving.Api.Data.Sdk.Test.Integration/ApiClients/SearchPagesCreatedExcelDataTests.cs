...
namespace GG.Api.Services.Data.Sdk.Test.Integration
{
    ...
    public class SearchPagesCreatedExcelDataTests
    {
        [Test]
        public void CustomCodes_Existing_IsValidCsv()
        {
            ...
            // Act
            var data = dataApiClient.Search(new PageCreatedSearchQuery { EventCustomCode1 = TestContext.KnownEventCustomCode1, EventCustomCode2 = TestContext.KnownEventCustomCode2, EventCustomCode3 = TestContext.KnownEventCustomCode3 }, DateTime.Now.AddMonths(-3), DateTime.Now, DataFileFormat.excel);
